...
<html>
	<head>
		<meta charset="utf-8">
		<meta name="author" content="Cleber Batista Graciano">
		<!-- Comando meta para configutar site para dispositivos mobile -->
		<!-- <meta name="viewport" content="width:device-width, initial-scale=2, user-sacalable=no"> -->
	...
	<body>
		...
		<header id="inicio">
			...
			<!-- Classe class="list-unstyled" tira o stilo da lista, os pontinhos -->
				...
				<div class="row">
					...
					<nav id="menu" class="pull-right">
						<ul>
							...
							<li><a href="#">News</a></li>
							<li><a href="#">Schedule</a></li>
							<li class="search"><div class="input-group">
